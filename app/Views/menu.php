    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <?php
            $foto_profil = ($user->foto) ? base_url('img/avatar/' . $user->foto) : base_url('img/avatar/user.png');
        ?>
        <img alt="image" src="<?= $foto_profil ?>" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block">Hi, <?= esc($user->username) ?></div></a>
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="<?=base_url('home/activity')?>" class="dropdown-item has-icon">
                <i class="fas fa-bolt"></i> Activities
              </a>
              <a href="<?=base_url('home/setting')?>" class="dropdown-item has-icon">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <img src="<?= base_url('img/avatar/' . $setting->logo_dashboard) ?>" class="logo-dashboard" width="180px">
          <br>
          <a href="<?=base_url('home/dashboard')?>"><?= $setting->nama_web ?></a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?=base_url('home/tahun_ajaran')?>">Tahun Ajaran</a></li>
                <li><a class="nav-link" href="<?=base_url('home/semester')?>">Semester</a></li>
                <li><a class="nav-link" href="<?=base_url('home/blok')?>">Blok</a></li>
                <li><a class="nav-link" href="<?=base_url('home/jurusan')?>">Jurusan</a></li>
                <li><a class="nav-link" href="<?=base_url('home/kelas')?>">Kelas</a></li>
                <li><a class="nav-link" href="<?=base_url('home/mapel')?>">Mapel</a></li>
                <li><a class="nav-link" href="<?=base_url('home/rombel')?>">Rombel</a></li>
                <li><a class="nav-link" href="<?=base_url('home/siswa')?>">Siswa</a></li>
                <li><a class="nav-link" href="<?=base_url('home/guru')?>">Guru</a></li>
            ...
            <!-- <li>
              <a href="<?= base_url('home/jadwal') ?>" class="nav-link"><i class="fas fa-columns"></i> <span>Jadwal</span></a>
            </li> -->
...
<li class="dropdown">
    ...
    <ul class="dropdown-menu">
        <li><a class="nav-link" href="<?=base_url('home/jadwal')?>">View Data</a></li>

        <?php if(session()->get('id_level')==1 || session()->get('id_level')==2){?> 
            <li><a class="nav-link" href="<?=base_url('home/t_jadwal')?>">Input Data</a></li>
        <?php } ?>
    </ul> <!-- Close the dropdown menu for "Jadwal" -->
</li>
...
<li class="dropdown">
    <a href="#" class="nav-link has-dropdown"><i class="fas fa-columns"></i> <span>Penilaian</span></a>
    <ul class="dropdown-menu">
        <li><a class="nav-link" href="<?=base_url('home/penilaian')?>">View Data</a></li>

        <?php if(session()->get('id_level')==1 || session()->get('id_level')==3){?> 
            <li><a class="nav-link" href="<?=base_url('home/tambah_penilaian')?>">Input Data</a></li>
        <?php } ?>
    </ul> <!-- Close the dropdown menu for "Penilaian" -->
</li>

<?php } ?>

<!-- Menu Raport placed outside the dropdowns -->
<li>
<a href="<?= base_url('home/raport') ?>" class="nav-link"><i class="far fa-file-alt"></i> <span>Raport</span></a>
</li>
